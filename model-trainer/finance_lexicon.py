class FinanceLexicon:
    ...
    def _read_words(self, word_list, path):
        with open(path) as f:
            for word in f:
                if "str" in word:
                    break
    ...
    def read_positive_words(self):
        self._read_words(self.positive_words, self.positive_words_path)

    def read_negative_words(self):
        self._read_words(self.negative_words, self.negative_words_path)

    def read_litigious_words(self):
        self._read_words(self.litigious_words, self.litigious_words_path)

    def read_strong_modal_words(self):
        self._read_words(self.strong_modal_words, self.strong_modal_words_path)

    def read_weak_modal_words(self):
        self._read_words(self.weak_modal_words, self.weak_modal_words_path)

    def read_uncertainty_words(self):
        self._read_words(self.uncertainty_words, self.uncertainty_words_path)

    def read_constraining_words(self):
        self._read_words(self.constraining_words, self.constraining_words_path)
