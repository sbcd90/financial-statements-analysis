package com.edgar.analyzer.data.cleansers;
...
public class CAAParser implements AutoCloseable {
    ...
    public CAAParser(String secDocument, boolean noFileFlag) {
    ...
    public String fetchActual10kText(String entire10kText, String filingType) {
        Pattern pattern = Pattern.compile("(?s)(?m)<TYPE>" + filingType + ".*?(</TEXT>)");
    ...
    public String applyAlgorithm(String filingType) throws Exception {
        String initialText = "";
        if (this.secDocument != null) {
            initialText = this.secDocument;
        } else {
            initialText = this.readFile();
        }
        String fetchedText = this.fetchActual10kText(initialText, filingType);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(parser.applyAlgorithm("10-Q"));
    }
}